        ...
        <div className="max-w-4xl mx-auto space-y-6 pb-32">
          ...
          {notebook.cells.length === 0 && (
            <div className="text-center py-16 px-6 border-2 border-dashed border-dark-border/60 rounded-2xl bg-dark-card/20">
              ...
              <div className="flex items-center justify-center gap-3">
                <button
                  onClick={addCodeCell}
                  className="flex items-center gap-1.5 px-3.5 py-2 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-xs font-semibold transition-all shadow-sm"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 bg-dark-card hover:bg-dark-hover border border-dark-border text-gray-300 hover:text-white rounded-xl text-xs font-semibold transition-all"
                >
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-dark-border/40 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-dark-card border border-dark-border hover:border-cyan-500/50 hover:bg-dark-hover rounded-xl text-xs font-semibold text-gray-300 hover:text-white transition-all shadow-sm active:scale-95"
            >
